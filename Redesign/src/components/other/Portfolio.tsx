    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                !isMobile ? "sticky top-0 h-screen flex overflow-hidden" : "relative h-auto block px-6"
            )}>

                {/* --- LEFT PANEL (Static) --- */}
                <div className={cn(
                    "flex flex-col justify-center z-30",
                    !isMobile ? "w-[35%] h-full pl-12 pr-6 bg-background" : "w-full mb-12"
                )}>
                ...
                <div className={cn(
                    !isMobile ? "w-[65%] h-full flex items-center overflow-hidden pl-8" : "w-full"
                )}>
                    <motion.div
                        style={!isMobile ? { x } : {}}
                        className={cn(
